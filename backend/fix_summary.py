...
class AudioPreprocessor:
    ...
    def extract_features_enhanced(self, file_path_or_waveform, sr=None):
        ...
        try:
            ...
            # 10. Spectral Roll-off (85% only, dropping 95% due to high correlation)
            ...
            # Delta MFCC features (mean only, dropping std)
            final_features.update({
                f'delta_mfcc_{i}_mean': np.mean(delta_mfccs[i]) for i in range(13)
            })
